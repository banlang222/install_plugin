...
class _MyAppState extends State<MyApp> {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          ...
          child: Platform.operatingSystem == 'ohos'
              ? Column(
                  children: [
                    Text('has new version ? ${hasNewVersion}'),
                    TextButton(
                        onPressed: () {
                          _checkUpdate();
                        },
                    ...
                    ElevatedButton(
                        onPressed: () {
                          InstallPlugin.open({
                            "bundleName": "com.wiki8.wiki8_harmony",
  ...
  void _checkUpdate() {
    InstallPlugin.checkUpdate().then((value) {
      print('check result: $value');
      hasNewVersion = value;
      setState(() {});
    }).catchError((e, t) {
      print('flutter received check err: e=$e, t=$t');
    });
  }

  void _showUpdateDialog() {
    InstallPlugin.showUpdateDialog().then((value) {
      print('show success ? $value');
    }).catchError((e, t) {
      print('flutter received show err: e=$e, t=$t');
    });
  }
  ...
  _networkInstallApk() async {
    ...
    final res = await InstallPlugin.installApk(savePath);
    _showResMsg(
