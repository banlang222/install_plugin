...
class InstallPlugin {
  ...
  // };
  //ohos only
  static Future<dynamic> open(Map<String, dynamic> want) async {
    return await _channel.invokeMethod('open', want);
  }

  //ohos only
  //check update from store
  ...
  static Future<bool> showUpdateDialog() async {
    return await _channel.invokeMethod('showUpdateDialog');
  }
